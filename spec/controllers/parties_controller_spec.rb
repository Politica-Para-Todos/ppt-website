...
RSpec.describe PartiesController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: party.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      party = Party.create! valid_attributes
      get :edit, params: {id: party.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested party" do
        party = Party.create! valid_attributes
        put :update, params: {id: party.to_param, party: new_attributes}, session: valid_session
        party.reload
      ...
      it "redirects to the party" do
        party = Party.create! valid_attributes
        put :update, params: {id: party.to_param, party: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        party = Party.create! valid_attributes
        put :update, params: {id: party.to_param, party: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested party" do
      party = Party.create! valid_attributes
      expect {
        delete :destroy, params: {id: party.to_param}, session: valid_session
      }.to change(Party, :count).by(-1)
    end
