...
class HomeMovement extends PureComponent {
    render() {
        return (
            <section className="home-join">
                ...
                <div className="home-join-container">
                    ...
                    <p>
                        ...
                        rel="noopener" href="https://www.loomio.org/g/ZqT2uPv6/politica-para-todos">neste link</a> para ver toda a nossa comunicação, e caso queiras contribuir, vai até à conversa "Como Contribuir". Ficamos à espera!
                        </p>
                </div>
            </section>
        );
